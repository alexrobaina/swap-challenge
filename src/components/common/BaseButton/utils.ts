export const setType = (type: string) => {
  switch (type) {
    case 'primary':
      return 'w-full w-auto rounded-2xl bg-[#311C31] px-3 py-2 text-center text-xl font-semibold text-primary-500 hover:text-primary-50 shadow-sm hover:bg-primary-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#311C31] iconPrimary'
    case 'secondary':
